...
#include "TitleLocalUser_Android.h"
...
AndroidLocalUserContext::AndroidLocalUserContext(String _customId) : customId{ std::move(_customId) }
{
}

HRESULT CALLBACK AndroidLocalUserContext::LocalUserLoginHandler(
