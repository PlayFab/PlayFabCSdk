...
make TestApp
sudo cmake -S "$SCRIPT_DIR" -B "$SCRIPT_DIR"/../../../Int/CMake/PlayFabTestApp.Linux -D CMAKE_BUILD_TYPE=$CONFIGURATION -D LHC_PATH=$LHC_PATH -D PlayFabServicesLinux_DIR=$SCRIPT_DIR/../../../Int/CMake/PlayFabServicesLinux
