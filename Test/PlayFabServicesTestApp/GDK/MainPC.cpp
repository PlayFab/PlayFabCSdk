...
LPCWSTR g_szAppName = L"PFTestAppPC";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    LoadLibraryW(L"OnDemandConnRouteHelper");
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"PFTestAppPCWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"PFTestAppPCWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // Change to CreateWindowExW(WS_EX_TOPMOST, L"PFTestAppPCWindowClass", g_szAppName, WS_POPUP,
