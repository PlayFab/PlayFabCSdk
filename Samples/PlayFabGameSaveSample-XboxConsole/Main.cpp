...
LPCWSTR g_szAppName = L"PlayFabGameSaveSample-XboxConsole";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"PlayFabGameSaveSample-XboxConsoleWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"PlayFabGameSaveSample-XboxConsoleWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_KEYDOWN:
        ...
        if (sample)
        {
            sample->OnKeyDown(static_cast<WPARAM>(wParam));
        }
#endif
        break;
    case WM_KEYUP:
