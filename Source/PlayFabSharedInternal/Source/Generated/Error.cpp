...
HRESULT ServiceErrorToHR(ServiceErrorCode errorCode)
{
    ...
    case ServiceErrorCode::LeaderboardNameConflict: return E_PF_LEADERBOARD_NAME_CONFLICT;
    case ServiceErrorCode::LinkedStatisticColumnMismatch: return E_PF_LINKED_STATISTIC_COLUMN_MISMATCH;
    case ServiceErrorCode::NoLinkedStatisticToLeaderboard: return E_PF_NO_LINKED_STATISTIC_TO_LEADERBOARD;
    case ServiceErrorCode::StatDefinitionAlreadyLinkedToLeaderboard: return E_PF_STAT_DEFINITION_ALREADY_LINKED_TO_LEADERBOARD;
    case ServiceErrorCode::LinkingStatsNotAllowedForEntityType: return E_PF_LINKING_STATS_NOT_ALLOWED_FOR_ENTITY_TYPE;
    case ServiceErrorCode::LeaderboardCountLimitExceeded: return E_PF_LEADERBOARD_COUNT_LIMIT_EXCEEDED;
    case ServiceErrorCode::LeaderboardSizeLimitExceeded: return E_PF_LEADERBOARD_SIZE_LIMIT_EXCEEDED;
    case ServiceErrorCode::LeaderboardDefinitionModificationNotAllowedWhileLinked: return E_PF_LEADERBOARD_DEFINITION_MODIFICATION_NOT_ALLOWED_WHILE_LINKED;
    case ServiceErrorCode::StatisticDefinitionModificationNotAllowedWhileLinked: return E_PF_STATISTIC_DEFINITION_MODIFICATION_NOT_ALLOWED_WHILE_LINKED;
    case ServiceErrorCode::LeaderboardUpdateNotAllowedWhileLinked: return E_PF_LEADERBOARD_UPDATE_NOT_ALLOWED_WHILE_LINKED;
    case ServiceErrorCode::CloudScriptAzureFunctionsEventHubRequestError: return E_PF_CLOUD_SCRIPT_AZURE_FUNCTIONS_EVENT_HUB_REQUEST_ERROR;
    case ServiceErrorCode::ExternalEntityNotAllowedForTier: return E_PF_EXTERNAL_ENTITY_NOT_ALLOWED_FOR_TIER;
    case ServiceErrorCode::InvalidBaseTimeForInterval: return E_PF_INVALID_BASE_TIME_FOR_INTERVAL;
    case ServiceErrorCode::EntityTypeMismatchWithStatDefinition: return E_PF_ENTITY_TYPE_MISMATCH_WITH_STAT_DEFINITION;
    case ServiceErrorCode::SpecifiedVersionLeaderboardNotFound: return E_PF_SPECIFIED_VERSION_LEADERBOARD_NOT_FOUND;
    case ServiceErrorCode::LeaderboardColumnLengthMismatchWithStatDefinition: return E_PF_LEADERBOARD_COLUMN_LENGTH_MISMATCH_WITH_STAT_DEFINITION;
    case ServiceErrorCode::DuplicateColumnNameFound: return E_PF_DUPLICATE_COLUMN_NAME_FOUND;
    case ServiceErrorCode::LinkedStatisticColumnNotFound: return E_PF_LINKED_STATISTIC_COLUMN_NOT_FOUND;
    case ServiceErrorCode::LinkedStatisticColumnRequired: return E_PF_LINKED_STATISTIC_COLUMN_REQUIRED;
    case ServiceErrorCode::MultipleLinkedStatisticsNotAllowed: return E_PF_MULTIPLE_LINKED_STATISTICS_NOT_ALLOWED;
    case ServiceErrorCode::DuplicateLinkedStatisticColumnNameFound: return E_PF_DUPLICATE_LINKED_STATISTIC_COLUMN_NAME_FOUND;
    case ServiceErrorCode::AggregationTypeNotAllowedForMultiColumnStatistic: return E_PF_AGGREGATION_TYPE_NOT_ALLOWED_FOR_MULTI_COLUMN_STATISTIC;
    ...
    case ServiceErrorCode::InvalidVersionResetForLinkedLeaderboard: return E_PF_INVALID_VERSION_RESET_FOR_LINKED_LEADERBOARD;
    case ServiceErrorCode::BattleNetNotEnabledForTitle: return E_PF_BATTLE_NET_NOT_ENABLED_FOR_TITLE;
    case ServiceErrorCode::ReportNotProcessed: return E_PF_REPORT_NOT_PROCESSED;
    case ServiceErrorCode::DataNotAvailable: return E_PF_DATA_NOT_AVAILABLE;
    case ServiceErrorCode::InvalidReportName: return E_PF_INVALID_REPORT_NAME;
    case ServiceErrorCode::ResourceNotModified: return E_PF_RESOURCE_NOT_MODIFIED;
    case ServiceErrorCode::StudioCreationLimitExceeded: return E_PF_STUDIO_CREATION_LIMIT_EXCEEDED;
    case ServiceErrorCode::StudioDeletionInitiated: return E_PF_STUDIO_DELETION_INITIATED;
    case ServiceErrorCode::ProductDisabledForTitle: return E_PF_PRODUCT_DISABLED_FOR_TITLE;
    case ServiceErrorCode::PreconditionFailed: return E_PF_PRECONDITION_FAILED;
    case ServiceErrorCode::CannotEnableAnonymousPlayerCreation: return E_PF_CANNOT_ENABLE_ANONYMOUS_PLAYER_CREATION;
    ...
    case ServiceErrorCode::EventSinkTenantIdInvalid: return E_PF_EVENT_SINK_TENANT_ID_INVALID;
    case ServiceErrorCode::EventSinkResourceMisconfigured: return E_PF_EVENT_SINK_RESOURCE_MISCONFIGURED;
    case ServiceErrorCode::EventSinkAccessDenied: return E_PF_EVENT_SINK_ACCESS_DENIED;
    case ServiceErrorCode::EventSinkWriteConflict: return E_PF_EVENT_SINK_WRITE_CONFLICT;
    case ServiceErrorCode::EventSinkResourceNotFound: return E_PF_EVENT_SINK_RESOURCE_NOT_FOUND;
    case ServiceErrorCode::EventSinkResourceFeatureNotSupported: return E_PF_EVENT_SINK_RESOURCE_FEATURE_NOT_SUPPORTED;
    case ServiceErrorCode::EventSinkBucketNameInvalid: return E_PF_EVENT_SINK_BUCKET_NAME_INVALID;
    case ServiceErrorCode::EventSinkResourceUnavailable: return E_PF_EVENT_SINK_RESOURCE_UNAVAILABLE;
    ...
    case ServiceErrorCode::TrueSkillInvalidModelId: return E_PF_TRUE_SKILL_INVALID_MODEL_ID;
    case ServiceErrorCode::TrueSkillInvalidModelName: return E_PF_TRUE_SKILL_INVALID_MODEL_NAME;
    case ServiceErrorCode::TrueSkillInvalidPlayerIds: return E_PF_TRUE_SKILL_INVALID_PLAYER_IDS;
    case ServiceErrorCode::TrueSkillInvalidEntityKey: return E_PF_TRUE_SKILL_INVALID_ENTITY_KEY;
    case ServiceErrorCode::TrueSkillInvalidConditionKey: return E_PF_TRUE_SKILL_INVALID_CONDITION_KEY;
    case ServiceErrorCode::TrueSkillInvalidConditionValue: return E_PF_TRUE_SKILL_INVALID_CONDITION_VALUE;
    case ServiceErrorCode::TrueSkillInvalidConditionAffinityWeight: return E_PF_TRUE_SKILL_INVALID_CONDITION_AFFINITY_WEIGHT;
    case ServiceErrorCode::TrueSkillInvalidEventName: return E_PF_TRUE_SKILL_INVALID_EVENT_NAME;
    case ServiceErrorCode::TrueSkillMatchResultCreated: return E_PF_TRUE_SKILL_MATCH_RESULT_CREATED;
    case ServiceErrorCode::TrueSkillMatchResultAlreadySubmitted: return E_PF_TRUE_SKILL_MATCH_RESULT_ALREADY_SUBMITTED;
    case ServiceErrorCode::TrueSkillBadPlayerIdInMatchResult: return E_PF_TRUE_SKILL_BAD_PLAYER_ID_IN_MATCH_RESULT;
    case ServiceErrorCode::TrueSkillInvalidBotIdInMatchResult: return E_PF_TRUE_SKILL_INVALID_BOT_ID_IN_MATCH_RESULT;
    case ServiceErrorCode::TrueSkillDuplicatePlayerInMatchResult: return E_PF_TRUE_SKILL_DUPLICATE_PLAYER_IN_MATCH_RESULT;
    case ServiceErrorCode::TrueSkillNoPlayerInMatchResultTeam: return E_PF_TRUE_SKILL_NO_PLAYER_IN_MATCH_RESULT_TEAM;
    case ServiceErrorCode::TrueSkillPlayersInMatchResultExceedingLimit: return E_PF_TRUE_SKILL_PLAYERS_IN_MATCH_RESULT_EXCEEDING_LIMIT;
    case ServiceErrorCode::TrueSkillInvalidPreMatchPartyInMatchResult: return E_PF_TRUE_SKILL_INVALID_PRE_MATCH_PARTY_IN_MATCH_RESULT;
    case ServiceErrorCode::TrueSkillInvalidTimestampInMatchResult: return E_PF_TRUE_SKILL_INVALID_TIMESTAMP_IN_MATCH_RESULT;
    case ServiceErrorCode::TrueSkillStartTimeMissingInMatchResult: return E_PF_TRUE_SKILL_START_TIME_MISSING_IN_MATCH_RESULT;
    case ServiceErrorCode::TrueSkillEndTimeMissingInMatchResult: return E_PF_TRUE_SKILL_END_TIME_MISSING_IN_MATCH_RESULT;
    case ServiceErrorCode::TrueSkillInvalidPlayerSecondsPlayedInMatchResult: return E_PF_TRUE_SKILL_INVALID_PLAYER_SECONDS_PLAYED_IN_MATCH_RESULT;
    case ServiceErrorCode::TrueSkillNoTeamInMatchResult: return E_PF_TRUE_SKILL_NO_TEAM_IN_MATCH_RESULT;
    case ServiceErrorCode::TrueSkillNotEnoughTeamsInMatchResult: return E_PF_TRUE_SKILL_NOT_ENOUGH_TEAMS_IN_MATCH_RESULT;
    ...
    case ServiceErrorCode::TrueSkillMissingRequiredCondition: return E_PF_TRUE_SKILL_MISSING_REQUIRED_CONDITION;
    case ServiceErrorCode::TrueSkillMissingRequiredEvent: return E_PF_TRUE_SKILL_MISSING_REQUIRED_EVENT;
    case ServiceErrorCode::TrueSkillUnknownEventName: return E_PF_TRUE_SKILL_UNKNOWN_EVENT_NAME;
    case ServiceErrorCode::TrueSkillInvalidEventCount: return E_PF_TRUE_SKILL_INVALID_EVENT_COUNT;
    case ServiceErrorCode::TrueSkillUnknownConditionKey: return E_PF_TRUE_SKILL_UNKNOWN_CONDITION_KEY;
    case ServiceErrorCode::TrueSkillUnknownConditionValue: return E_PF_TRUE_SKILL_UNKNOWN_CONDITION_VALUE;
    case ServiceErrorCode::TrueSkillScenarioConfigDoesNotExist: return E_PF_TRUE_SKILL_SCENARIO_CONFIG_DOES_NOT_EXIST;
    case ServiceErrorCode::TrueSkillUnknownModelId: return E_PF_TRUE_SKILL_UNKNOWN_MODEL_ID;
    case ServiceErrorCode::TrueSkillNoModelInScenario: return E_PF_TRUE_SKILL_NO_MODEL_IN_SCENARIO;
    case ServiceErrorCode::TrueSkillNotSupportedForTitle: return E_PF_TRUE_SKILL_NOT_SUPPORTED_FOR_TITLE;
    case ServiceErrorCode::TrueSkillModelIsNotActive: return E_PF_TRUE_SKILL_MODEL_IS_NOT_ACTIVE;
    case ServiceErrorCode::TrueSkillUnauthorizedToQueryOtherPlayerSkills: return E_PF_TRUE_SKILL_UNAUTHORIZED_TO_QUERY_OTHER_PLAYER_SKILLS;
    case ServiceErrorCode::TrueSkillInvalidMaxIterations: return E_PF_TRUE_SKILL_INVALID_MAX_ITERATIONS;
    case ServiceErrorCode::TrueSkillEndTimeBeforeStartTime: return E_PF_TRUE_SKILL_END_TIME_BEFORE_START_TIME;
    case ServiceErrorCode::TrueSkillInvalidJobId: return E_PF_TRUE_SKILL_INVALID_JOB_ID;
    case ServiceErrorCode::TrueSkillInvalidMetadataId: return E_PF_TRUE_SKILL_INVALID_METADATA_ID;
    case ServiceErrorCode::TrueSkillMissingBuildVerison: return E_PF_TRUE_SKILL_MISSING_BUILD_VERISON;
    case ServiceErrorCode::TrueSkillJobAlreadyExists: return E_PF_TRUE_SKILL_JOB_ALREADY_EXISTS;
    case ServiceErrorCode::TrueSkillJobNotFound: return E_PF_TRUE_SKILL_JOB_NOT_FOUND;
    case ServiceErrorCode::TrueSkillOperationCanceled: return E_PF_TRUE_SKILL_OPERATION_CANCELED;
    case ServiceErrorCode::TrueSkillActiveModelLimitExceeded: return E_PF_TRUE_SKILL_ACTIVE_MODEL_LIMIT_EXCEEDED;
    case ServiceErrorCode::TrueSkillTotalModelLimitExceeded: return E_PF_TRUE_SKILL_TOTAL_MODEL_LIMIT_EXCEEDED;
    case ServiceErrorCode::TrueSkillUnknownInitialModelId: return E_PF_TRUE_SKILL_UNKNOWN_INITIAL_MODEL_ID;
    case ServiceErrorCode::TrueSkillUnauthorizedForJob: return E_PF_TRUE_SKILL_UNAUTHORIZED_FOR_JOB;
    case ServiceErrorCode::TrueSkillInvalidScenarioName: return E_PF_TRUE_SKILL_INVALID_SCENARIO_NAME;
    case ServiceErrorCode::TrueSkillConditionStateIsRequired: return E_PF_TRUE_SKILL_CONDITION_STATE_IS_REQUIRED;
    case ServiceErrorCode::TrueSkillEventStateIsRequired: return E_PF_TRUE_SKILL_EVENT_STATE_IS_REQUIRED;
    case ServiceErrorCode::TrueSkillDuplicateEvent: return E_PF_TRUE_SKILL_DUPLICATE_EVENT;
    case ServiceErrorCode::TrueSkillDuplicateCondition: return E_PF_TRUE_SKILL_DUPLICATE_CONDITION;
    case ServiceErrorCode::TrueSkillInvalidAnomalyThreshold: return E_PF_TRUE_SKILL_INVALID_ANOMALY_THRESHOLD;
    case ServiceErrorCode::TrueSkillConditionKeyLimitExceeded: return E_PF_TRUE_SKILL_CONDITION_KEY_LIMIT_EXCEEDED;
    case ServiceErrorCode::TrueSkillConditionValuePerKeyLimitExceeded: return E_PF_TRUE_SKILL_CONDITION_VALUE_PER_KEY_LIMIT_EXCEEDED;
    case ServiceErrorCode::TrueSkillInvalidTimestamp: return E_PF_TRUE_SKILL_INVALID_TIMESTAMP;
    case ServiceErrorCode::TrueSkillEventLimitExceeded: return E_PF_TRUE_SKILL_EVENT_LIMIT_EXCEEDED;
    case ServiceErrorCode::TrueSkillInvalidPlayers: return E_PF_TRUE_SKILL_INVALID_PLAYERS;
    case ServiceErrorCode::TrueSkillTrueSkillPlayerNull: return E_PF_TRUE_SKILL_TRUE_SKILL_PLAYER_NULL;
    ...
    case ServiceErrorCode::TrueSkillInvalidConditionsList: return E_PF_TRUE_SKILL_INVALID_CONDITIONS_LIST;
    ...
    case ServiceErrorCode::GameSaveManifestUpdatesNotAllowed: return E_PF_GAME_SAVE_MANIFEST_UPDATES_NOT_ALLOWED;
    case ServiceErrorCode::GameSaveFileAlreadyExists: return E_PF_GAME_SAVE_FILE_ALREADY_EXISTS;
    case ServiceErrorCode::GameSaveManifestVersionNotFinalized: return E_PF_GAME_SAVE_MANIFEST_VERSION_NOT_FINALIZED;
    ...
    case ServiceErrorCode::GameSaveManifestUploadProgressUpdateNotAllowed: return E_PF_GAME_SAVE_MANIFEST_UPLOAD_PROGRESS_UPDATE_NOT_ALLOWED;
    case ServiceErrorCode::GameSaveNotFinalizedManifestNotEligibleAsKnownGood: return E_PF_GAME_SAVE_NOT_FINALIZED_MANIFEST_NOT_ELIGIBLE_AS_KNOWN_GOOD;
    case ServiceErrorCode::GameSaveNoUpdatesRequested: return E_PF_GAME_SAVE_NO_UPDATES_REQUESTED;
    case ServiceErrorCode::GameSaveTitleDoesNotExist: return E_PF_GAME_SAVE_TITLE_DOES_NOT_EXIST;
    case ServiceErrorCode::GameSaveOperationNotAllowedForTitle: return E_PF_GAME_SAVE_OPERATION_NOT_ALLOWED_FOR_TITLE;
    case ServiceErrorCode::GameSaveManifestFilesLimitExceeded: return E_PF_GAME_SAVE_MANIFEST_FILES_LIMIT_EXCEEDED;
    case ServiceErrorCode::GameSaveManifestDescriptionUpdateNotAllowed: return E_PF_GAME_SAVE_MANIFEST_DESCRIPTION_UPDATE_NOT_ALLOWED;
    case ServiceErrorCode::GameSaveTitleConfigNotFound: return E_PF_GAME_SAVE_TITLE_CONFIG_NOT_FOUND;
    case ServiceErrorCode::GameSaveTitleAlreadyOnboarded: return E_PF_GAME_SAVE_TITLE_ALREADY_ONBOARDED;
    case ServiceErrorCode::GameSaveServiceNotEnabledForTitle: return E_PF_GAME_SAVE_SERVICE_NOT_ENABLED_FOR_TITLE;
    case ServiceErrorCode::GameSaveServiceOnboardingPending: return E_PF_GAME_SAVE_SERVICE_ONBOARDING_PENDING;
    case ServiceErrorCode::GameSaveManifestNotEligibleAsConflictingVersion: return E_PF_GAME_SAVE_MANIFEST_NOT_ELIGIBLE_AS_CONFLICTING_VERSION;
    case ServiceErrorCode::GameSaveServiceUnavailable: return E_PF_GAME_SAVE_SERVICE_UNAVAILABLE;
    ...
    case ServiceErrorCode::StateShareStateRedemptionLimitExceeded: return E_PF_STATE_SHARE_STATE_REDEMPTION_LIMIT_EXCEEDED;
    case ServiceErrorCode::StateShareStateRedemptionLimitNotUpdated: return E_PF_STATE_SHARE_STATE_REDEMPTION_LIMIT_NOT_UPDATED;
    case ServiceErrorCode::StateShareCreatedStatesLimitExceeded: return E_PF_STATE_SHARE_CREATED_STATES_LIMIT_EXCEEDED;
    case ServiceErrorCode::StateShareIdMissingOrMalformed: return E_PF_STATE_SHARE_ID_MISSING_OR_MALFORMED;
    case ServiceErrorCode::PlayerCreationDisabled: return E_PF_PLAYER_CREATION_DISABLED;
    case ServiceErrorCode::AccountAlreadyExists: return E_PF_ACCOUNT_ALREADY_EXISTS;
    case ServiceErrorCode::TagInvalid: return E_PF_TAG_INVALID;
    case ServiceErrorCode::TagTooLong: return E_PF_TAG_TOO_LONG;
    case ServiceErrorCode::StatisticColumnAggregationMismatch: return E_PF_STATISTIC_COLUMN_AGGREGATION_MISMATCH;
    case ServiceErrorCode::StatisticResetIntervalMismatch: return E_PF_STATISTIC_RESET_INTERVAL_MISMATCH;
    case ServiceErrorCode::VersionConfigurationCannotBeSpecifiedForLinkedStat: return E_PF_VERSION_CONFIGURATION_CANNOT_BE_SPECIFIED_FOR_LINKED_STAT;
    case ServiceErrorCode::VersionConfigurationIsRequired: return E_PF_VERSION_CONFIGURATION_IS_REQUIRED;
    case ServiceErrorCode::InvalidEntityTypeForAggregation: return E_PF_INVALID_ENTITY_TYPE_FOR_AGGREGATION;
    case ServiceErrorCode::MultiLevelAggregationNotAllowed: return E_PF_MULTI_LEVEL_AGGREGATION_NOT_ALLOWED;
    case ServiceErrorCode::AggregationTypeNotAllowedForLinkedStat: return E_PF_AGGREGATION_TYPE_NOT_ALLOWED_FOR_LINKED_STAT;
    case ServiceErrorCode::OperationDeniedDueToDefinitionPolicy: return E_PF_OPERATION_DENIED_DUE_TO_DEFINITION_POLICY;
    case ServiceErrorCode::StatisticUpdateNotAllowedWhileLinked: return E_PF_STATISTIC_UPDATE_NOT_ALLOWED_WHILE_LINKED;
    case ServiceErrorCode::UnsupportedEntityType: return E_PF_UNSUPPORTED_ENTITY_TYPE;
