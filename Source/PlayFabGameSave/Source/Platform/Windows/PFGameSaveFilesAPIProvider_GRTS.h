...
class GameSaveAPIProviderGRTS : public GameSaveAPIProvider
{
public:
    GameSaveAPIProviderGRTS() = default;
...
private:
    ...
    // Cached from PFGameSaveFilesInitialize for potential file location override
    String m_initSaveFolder;
};
