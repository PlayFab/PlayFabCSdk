...
String GameSaveHttpClient::GetUrl(String const& connectionString, const char* path)
{
...
UnorderedMap<String, String> GameSaveHttpClient::GetDefaultHeaders()
{
...
AsyncOp<ServiceResponse> GameSaveHttpClient::MakePostRequest(
...
AsyncOp<ServiceResponse> GameSaveHttpClient::MakeSecretKeyRequest(
    ServicesCacheId cacheId,
    Entity const& entity,
    const char* path,
    JsonValue const& requestBody,
