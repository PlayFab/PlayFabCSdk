...
{
public:
    using ModelType = PFAuthenticationGetPhotonAuthenticationTokenRequest;
...
{
public:
    using ModelType = PFAuthenticationGetPhotonAuthenticationTokenResult;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = PFAuthenticationGetTitlePublicKeyRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = PFAuthenticationGetTitlePublicKeyResult;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
template<template<typename AllocT> class Alloc = std::allocator>
class PFAuthenticationSetPlayerSecretRequestWrapper : public ModelWrapper<PFAuthenticationSetPlayerSecretRequest, Alloc>
{
public:
    using ModelType = PFAuthenticationSetPlayerSecretRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;

    PFAuthenticationSetPlayerSecretRequestWrapper() = default;

    PFAuthenticationSetPlayerSecretRequestWrapper(const PFAuthenticationSetPlayerSecretRequest& model) :
        ModelWrapper<PFAuthenticationSetPlayerSecretRequest, Alloc>{ model },
        m_encryptedRequest{ SafeString(model.encryptedRequest) },
        m_playerSecret{ SafeString(model.playerSecret) }
    {
        SetModelPointers();
    ...
    PFAuthenticationSetPlayerSecretRequestWrapper(const PFAuthenticationSetPlayerSecretRequestWrapper& src) :
        PFAuthenticationSetPlayerSecretRequestWrapper{ src.Model() }
    {
    }

    PFAuthenticationSetPlayerSecretRequestWrapper(PFAuthenticationSetPlayerSecretRequestWrapper&& src) :
        PFAuthenticationSetPlayerSecretRequestWrapper{}
    {
        swap(*this, src);
    }

    PFAuthenticationSetPlayerSecretRequestWrapper& operator=(PFAuthenticationSetPlayerSecretRequestWrapper src) 
    {
        swap(*this, src);
        return *this;
    }

    virtual ~PFAuthenticationSetPlayerSecretRequestWrapper() = default;

    friend void swap(PFAuthenticationSetPlayerSecretRequestWrapper& lhs, PFAuthenticationSetPlayerSecretRequestWrapper& rhs)
    {
        using std::swap;
        swap(lhs.m_model, rhs.m_model);
        swap(lhs.m_encryptedRequest, rhs.m_encryptedRequest);
