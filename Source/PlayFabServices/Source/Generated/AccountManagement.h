...
public:
    ...
    static AsyncOp<GetPlayFabIDsFromBattleNetAccountIdsResult> ClientGetPlayFabIDsFromBattleNetAccountIds(Entity const& entity, const GetPlayFabIDsFromBattleNetAccountIdsRequest& request, RunContext rc);
    ...
    static AsyncOp<GetPlayFabIDsFromOpenIdsResult> ClientGetPlayFabIDsFromOpenIdSubjectIdentifiers(Entity const& entity, const GetPlayFabIDsFromOpenIdsRequest& request, RunContext rc);
    ...
    static AsyncOp<void> ClientLinkBattleNetAccount(Entity const& entity, const ClientLinkBattleNetAccountRequest& request, RunContext rc);
    ...
    static AsyncOp<void> ClientLinkTwitch(Entity const& entity, const ClientLinkTwitchAccountRequest& request, RunContext rc);
    ...
    static AsyncOp<void> ClientUnlinkTwitch(Entity const& entity, const ClientUnlinkTwitchAccountRequest& request, RunContext rc);
    ...
    static AsyncOp<GetPlayFabIDsFromBattleNetAccountIdsResult> ServerGetPlayFabIDsFromBattleNetAccountIds(Entity const& entity, const GetPlayFabIDsFromBattleNetAccountIdsRequest& request, RunContext rc);
    ...
    static AsyncOp<void> ServerLinkBattleNetAccount(Entity const& entity, const ServerLinkBattleNetAccountRequest& request, RunContext rc);
    ...
    static AsyncOp<void> ServerLinkTwitchAccount(Entity const& entity, const ServerLinkTwitchAccountRequest& request, RunContext rc);
    static AsyncOp<void> ServerLinkXboxAccount(Entity const& entity, const ServerLinkXboxAccountRequest& request, RunContext rc);
    static AsyncOp<void> ServerLinkXboxId(Entity const& entity, const LinkXboxIdRequest& request, RunContext rc);
    ...
    static AsyncOp<void> ServerUnlinkTwitchAccount(Entity const& entity, const ServerUnlinkTwitchAccountRequest& request, RunContext rc);
