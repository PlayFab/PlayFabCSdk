...
template<template<typename AllocT> class Alloc = std::allocator>
class PFEntityStatisticValueWrapper : public ModelWrapper<PFEntityStatisticValue, Alloc>
{
public:
    using ModelType = PFEntityStatisticValue;
    using DictionaryEntryType = PFEntityStatisticValueDictionaryEntry;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;

    PFEntityStatisticValueWrapper() = default;

    PFEntityStatisticValueWrapper(const PFEntityStatisticValue& model) :
        ModelWrapper<PFEntityStatisticValue, Alloc>{ model },
    ...
    PFEntityStatisticValueWrapper(const PFEntityStatisticValueWrapper& src) :
        PFEntityStatisticValueWrapper{ src.Model() }
    {
    }

    PFEntityStatisticValueWrapper(PFEntityStatisticValueWrapper&& src) :
        PFEntityStatisticValueWrapper{}
    {
        swap(*this, src);
    }

    PFEntityStatisticValueWrapper& operator=(PFEntityStatisticValueWrapper src) 
    {
        swap(*this, src);
        return *this;
    }

    virtual ~PFEntityStatisticValueWrapper() = default;

    friend void swap(PFEntityStatisticValueWrapper& lhs, PFEntityStatisticValueWrapper& rhs)
    {
        using std::swap;
        swap(lhs.m_model, rhs.m_model);
