...
public:
    ...
    String const& GetConfirmationMessage() const
    {
    ...
    String const& GetDeviceToken() const
    {
    ...
    std::optional<bool> const& GetSendPushNotificationConfirmation() const
    {
        return m_sendPushNotificationConfirmation;
    }
...
public:
    ...
    String const& GetAchievementName() const
    {
...
public:
    ...
    ModelVector<PFPlatformSpecificAwardSteamAchievementItemWrapper<Alloc>, Alloc> const& GetAchievements() const
    {
...
public:
    ...
    ModelVector<PFPlatformSpecificAwardSteamAchievementItemWrapper<Alloc>, Alloc> const& GetAchievementResults() const
    {
        return m_achievementResults;
    }
