...
public:
    ...
    std::optional<bool> const& GetGCMDataOnly() const
    {
        return m_gCMDataOnly;
    }
    ...
    PFPushNotificationPlatform GetPlatform() const
    {
        return this->m_model.platform;
    }
...
public:
    ...
    int32_t GetBadge() const
    {
        return this->m_model.badge;
    }
    ...
    String const& GetCustomData() const
    {
        return m_customData;
    }
...
public:
    ...
    ModelVector<PFPushNotificationsAdvancedPushPlatformMsgWrapper<Alloc>, Alloc> const& GetAdvancedPlatformDelivery() const
    {
        return m_advancedPlatformDelivery;
    }
    ...
    std::optional<PFPushNotificationsPushNotificationPackageWrapper<Alloc>> const& GetPackage() const
    {
        return m_package;
    }
    ...
    String const& GetRecipient() const
    {
        return m_recipient;
    }
    ...
    Vector<PFPushNotificationPlatform> const& GetTargetPlatforms() const
    {
...
public:
    ...
    String const& GetPushNotificationTemplateId() const
    {
        return m_pushNotificationTemplateId;
    }
