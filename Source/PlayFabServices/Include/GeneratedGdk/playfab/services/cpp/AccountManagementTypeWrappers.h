...
template<template<typename AllocT> class Alloc = std::allocator>
class PFAccountManagementSetDisplayNameRequestWrapper : public ModelWrapper<PFAccountManagementSetDisplayNameRequest, Alloc>
{
public:
    using ModelType = PFAccountManagementSetDisplayNameRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;

    PFAccountManagementSetDisplayNameRequestWrapper() = default;

    PFAccountManagementSetDisplayNameRequestWrapper(const PFAccountManagementSetDisplayNameRequest& model) :
        ModelWrapper<PFAccountManagementSetDisplayNameRequest, Alloc>{ model },
        m_customTags{ model.customTags, model.customTags + model.customTagsCount },
        m_displayName{ SafeString(model.displayName) },
    ...
    PFAccountManagementSetDisplayNameRequestWrapper(const PFAccountManagementSetDisplayNameRequestWrapper& src) :
        PFAccountManagementSetDisplayNameRequestWrapper{ src.Model() }
    {
    }

    PFAccountManagementSetDisplayNameRequestWrapper(PFAccountManagementSetDisplayNameRequestWrapper&& src) :
        PFAccountManagementSetDisplayNameRequestWrapper{}
    {
        swap(*this, src);
    }

    PFAccountManagementSetDisplayNameRequestWrapper& operator=(PFAccountManagementSetDisplayNameRequestWrapper src) 
    {
        swap(*this, src);
        return *this;
    }

    virtual ~PFAccountManagementSetDisplayNameRequestWrapper() = default;

    friend void swap(PFAccountManagementSetDisplayNameRequestWrapper& lhs, PFAccountManagementSetDisplayNameRequestWrapper& rhs)
    {
        using std::swap;
        swap(lhs.m_model, rhs.m_model);
        swap(lhs.m_customTags, rhs.m_customTags);
...
template<template<typename AllocT> class Alloc = std::allocator>
class PFAccountManagementSetDisplayNameResponseWrapper : public ModelWrapper<PFAccountManagementSetDisplayNameResponse, Alloc>
{
public:
    using ModelType = PFAccountManagementSetDisplayNameResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;

    PFAccountManagementSetDisplayNameResponseWrapper() = default;

    PFAccountManagementSetDisplayNameResponseWrapper(const PFAccountManagementSetDisplayNameResponse& model) :
        ModelWrapper<PFAccountManagementSetDisplayNameResponse, Alloc>{ model },
    ...
    PFAccountManagementSetDisplayNameResponseWrapper(const PFAccountManagementSetDisplayNameResponseWrapper& src) :
        PFAccountManagementSetDisplayNameResponseWrapper{ src.Model() }
    {
    }

    PFAccountManagementSetDisplayNameResponseWrapper(PFAccountManagementSetDisplayNameResponseWrapper&& src) :
        PFAccountManagementSetDisplayNameResponseWrapper{}
    {
        swap(*this, src);
    }

    PFAccountManagementSetDisplayNameResponseWrapper& operator=(PFAccountManagementSetDisplayNameResponseWrapper src) 
    {
        swap(*this, src);
        return *this;
    }

    virtual ~PFAccountManagementSetDisplayNameResponseWrapper() = default;

    friend void swap(PFAccountManagementSetDisplayNameResponseWrapper& lhs, PFAccountManagementSetDisplayNameResponseWrapper& rhs)
    {
        using std::swap;
        swap(lhs.m_model, rhs.m_model);
